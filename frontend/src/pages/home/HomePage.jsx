    ...
    <div className="flex flex-col items-center bg-gray-100 p-6 pt-32 lg:flex-row lg:items-start">
      <div className="flex w-full flex-col items-center rounded-lg border-gray-300 bg-white p-4 text-center lg:w-3/4">
        <div className="mb-4 mt-2 w-4/5 text-center">
          <h1 className="mb-2 text-4xl font-bold text-gray-900" data-screen-reader-text="Dialogue Cafe">
            Dialogue Cafe
          </h1>
          <p className="mb-6 text-xl text-gray-700" data-screen-reader-text="Dialogue Cafe has a very strong commitment to social inclusion and
        ...
        <header className="mb-4 text-3xl font-bold" data-screen-reader-text="Popular Orders">Popular Orders</header>
        ...
        <div className="mb-6 mt-4 flex w-full justify-center gap-6">
          ...
          >
            ...
            <span data-screen-reader-text="Learn Sign Language">Learn Sign Language</span>
          </a>
        </div>
        ...
        <div className="mt-4 flex w-full flex-col items-center space-y-2">
          <h2 className="text-3xl font-bold" data-screen-reader-text="Getting Here">Getting Here</h2>
          <div className="flex w-full items-start justify-between gap-8 px-4">
            ...
            <div className="w-1/3 space-y-6 text-left">
              <div className="space-y-2">
                ...
                <p className="text-gray-700" data-screen-reader-text="Royal Docks Center for Sustainability">
                  Royal Docks Center for Sustainability
                </p>
                <p className="text-gray-700" data-screen-reader-text=" University of East London Docklands Campus">
                  University of East London Docklands Campus
                </p>
                <p className="text-gray-700" data-screen-reader-text="4-6 University Way">4-6 University Way</p>
                <p className="text-gray-700" data-screen-reader-text="London E16 2RD">London E16 2RD</p>
              </div>

              <div className="space-y-4">
                <h3 className="text-xl font-semibold" data-screen-reader-text="Opening Hours">Opening Hours</h3>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-gray-700" data-screen-reader-text="Monday-Thursday">Monday-Thursday</span>
                    <span className="text-gray-700" data-screen-reader-text="08:00-17:00">08:00-17:00</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-700" data-screen-reader-text="Friday">Friday</span>
                    <span className="text-gray-700" data-screen-reader-text="08:00-13:00">08:00-13:00</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="mt-6 flex w-full flex-col items-center lg:mt-0 lg:w-1/4">
        <h1 className="mb-6 text-3xl font-bold" data-screen-reader-text="How to Order">How to Order</h1>
